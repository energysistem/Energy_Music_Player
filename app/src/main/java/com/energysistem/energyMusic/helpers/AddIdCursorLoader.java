...
/**
 * A loader that queries the {@link ContentResolver} and returns a {@link android.database.Cursor}.
 * This class implements the {@link android.support.v4.content.Loader} protocol in a standard way for
 * querying cursors, building on {@link android.support.v4.content.AsyncTaskLoader} to perform the cursor
 * query on a background thread so that it does not block the application's UI.
 *
 * <p>A CursorLoader must be built with the full information for the query to
 * perform, either through the
 * {@link #CursorLoader(android.content.Context, android.net.Uri, String[], String, String[], String)} or
 * creating an empty instance with {@link #CursorLoader(android.content.Context)} and filling
 * in the desired paramters with {@link #setUri(android.net.Uri)}, {@link #setSelection(String)},
