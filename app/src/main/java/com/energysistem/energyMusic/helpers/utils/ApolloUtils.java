...
import com.energysistem.energyMusic.activities.TracksBrowser;
...
public class ApolloUtils {
    ...
    public static void startTracksBrowser(String Type, long id, Cursor mCursor, Context context ) {
        ...
        if( Type == TYPE_ARTIST ){
            ...
            String path = mCursor.getString(mCursor.getColumnIndexOrThrow(Audio.Media.DATA));
            path = path.substring(0, path.lastIndexOf("/"));
            bundle.putString(MIME_TYPE, Audio.Media.CONTENT_TYPE);
