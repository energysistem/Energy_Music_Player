...
import com.energysistem.energyMusic.widgets.AppWidget11;
import com.energysistem.energyMusic.widgets.AppWidget41;
import com.energysistem.energyMusic.widgets.AppWidget42;
import com.energysistem.energyMusic.cache.ImageInfo;
import com.energysistem.energyMusic.helpers.GetBitmapTask;
...
import com.energysistem.energyMusic.preferences.SharedPreferencesCompat;
...
import static com.energysistem.energyMusic.Constants.APOLLO_PREFERENCES;
import static com.energysistem.energyMusic.Constants.DATA_SCHEME;
...
import static com.energysistem.energyMusic.Constants.VISUALIZATION_TYPE;
...
public class ApolloService extends Service implements GetBitmapTask.OnBitmapReadyListener {
    ...
    public static final String APOLLO_PACKAGE_NAME = "com.energysistem.energyMusic";

    public static final String MUSIC_PACKAGE_NAME = "com.android.music";

    public static final String PLAYSTATE_CHANGED = "com.energysistem.energyMusic.playstatechanged";

    public static final String META_CHANGED = "com.energysistem.energyMusic.metachanged";

    public static final String FAVORITE_CHANGED = "com.energysistem.energyMusic.favoritechanged";

    public static final String QUEUE_CHANGED = "com.energysistem.energyMusic.queuechanged";

    public static final String REPEATMODE_CHANGED = "com.energysistem.energyMusic.repeatmodechanged";

    public static final String SHUFFLEMODE_CHANGED = "com.energysistem.energyMusic.shufflemodechanged";

    public static final String PROGRESSBAR_CHANGED = "com.energysistem.energyMusic.progressbarchnaged";

    public static final String REFRESH_PROGRESSBAR = "com.energysistem.energyMusic.refreshprogessbar";

    public static final String CYCLEREPEAT_ACTION = "com.energysistem.energyMusic.musicservicecommand.cyclerepeat";

    public static final String TOGGLESHUFFLE_ACTION = "com.energysistem.energyMusic.musicservicecommand.toggleshuffle";

    public static final String SERVICECMD = "com.energysistem.energyMusic.musicservicecommand";
    ...
    public static final String TOGGLEPAUSE_ACTION = "com.energysistem.energyMusic.musicservicecommand.togglepause";

    public static final String PAUSE_ACTION = "com.energysistem.energyMusic.musicservicecommand.pause";

    public static final String PREVIOUS_ACTION = "com.energysistem.energyMusic.musicservicecommand.previous";

    public static final String NEXT_ACTION = "com.energysistem.energyMusic.musicservicecommand.next";
    ...
    String[] mCursorCols = new String[] {
            "audio._id AS _id", Audio.Media.ARTIST, Audio.Media.ALBUM,
            Audio.Media.TITLE, Audio.Media.DATA,
            Audio.Media.MIME_TYPE, Audio.Media.ALBUM_ID,
            Audio.Media.ARTIST_ID, Audio.Media.IS_PODCAST,
            Audio.Media.BOOKMARK
    };
     ...
     * "com.energysistem.energyMusic.metachanged" "com.energysistem.energyMusic.queuechanged",
     * "com.energysistem.energyMusic.playbackcomplete" "com.energysistem.energyMusic.playstatechanged"
    ...
    private void openCurrentAndNext() {
        synchronized (this) {
            ...
            stop(false);
                ...
                while(!open(Audio.Media.EXTERNAL_CONTENT_URI + "/" + mCursor.getLong(IDCOLIDX))) {
    ...
    private void updateNotification() {
        ...
        status.icon = R.drawable.stat_notify_music_alter;
        status.contentIntent = PendingIntent
                .getActivity(this, 0, new Intent("com.energysistem.energyMusic.PLAYBACK_VIEWER")
    ...
    public String getArtistName() {
        synchronized (this) {
            if (mCursor == null) {
                return getString(R.string.unknown_last_fm);
            }
