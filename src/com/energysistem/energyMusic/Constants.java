...
public final class Constants {
    ...
    public static final String BUILD_DEPENDS = "build_depends";
    public static final String BUILD_VERSION = "build_version";
    public static final String DELETE_CACHE = "delete_cache";

    // Last.fm API
    public final static String LASTFM_API_KEY = "1b85ed7137b5caa858d05af2f7e8ef7b";
    ...
    // Playlists
    public final static long PLAYLIST_UNKNOWN = -1L, PLAYLIST_ALL_SONGS = -2L, PLAYLIST_QUEUE = -3L,
            PLAYLIST_NEW = -4L, PLAYLIST_FAVORITES = -5L, PLAYLIST_RECENTLY_ADDED = -6L;
    ...
    public final static String INTENT_ADD_TO_PLAYLIST = "com.energysistem.energyMusic.ADD_TO_PLAYLIST",
            INTENT_PLAYLIST_LIST = "playlistlist",
            INTENT_CREATE_PLAYLIST = "com.energysistem.energyMusic.CREATE_PLAYLIST",
            INTENT_RENAME_PLAYLIST = "com.energysistem.energyMusic.RENAME_PLAYLIST",
