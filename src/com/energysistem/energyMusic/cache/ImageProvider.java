package com.energysistem.energyMusic.cache;
...
import static com.energysistem.energyMusic.Constants.*;
...
public class ImageProvider implements GetBitmapTask.OnBitmapReadyListener{
    ...
    protected ImageProvider( Activity activity ) {
        ...
        executor = new ThreadPoolExecutor(30, 30, 60, TimeUnit.SECONDS, new LinkedBlockingQueue<Runnable>(), new ThreadPoolExecutor.DiscardOldestPolicy());
    }
    ...
    public void loadImage( ImageView imageView, ImageInfo imageInfo ){
        ...
        //TODO: revisar cambio imageView null
        //imageView != null &&
        if(imageView != null && !setCachedBitmap(imageView, tag)){
            asyncLoad( tag, imageView, new GetBitmapTask( thumbSize, imageInfo, this, imageView.getContext() ) );
        }
    }
